...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        ConfigHostGroupBox->setGeometry(QRect(30, 260, 201, 311));
        ...
        HostLineEdit->setGeometry(QRect(20, 70, 161, 31));
        HostSubmitButton = new QPushButton(ConfigHostGroupBox);
        HostSubmitButton->setObjectName(QStringLiteral("HostSubmitButton"));
        HostSubmitButton->setGeometry(QRect(20, 250, 161, 41));
        HostSubmitButton->setStyleSheet(QStringLiteral("font: 75 11pt \"Courier New\";"));
        UserLineEdit = new QLineEdit(ConfigHostGroupBox);
        UserLineEdit->setObjectName(QStringLiteral("UserLineEdit"));
        UserLineEdit->setGeometry(QRect(20, 138, 161, 31));
        UswerLabel = new QLabel(ConfigHostGroupBox);
        UswerLabel->setObjectName(QStringLiteral("UswerLabel"));
        UswerLabel->setGeometry(QRect(30, 100, 141, 41));
        PasswordLineEdit = new QLineEdit(ConfigHostGroupBox);
        PasswordLineEdit->setObjectName(QStringLiteral("PasswordLineEdit"));
        PasswordLineEdit->setGeometry(QRect(20, 208, 161, 31));
        PasswordLabel = new QLabel(ConfigHostGroupBox);
        PasswordLabel->setObjectName(QStringLiteral("PasswordLabel"));
        PasswordLabel->setGeometry(QRect(10, 170, 171, 41));
...
"font: 75 36pt \"Courier New\";"));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        HostLabel->setText(QApplication::translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:16pt;\">Input Host</span></p></body></html>", 0));
        HostSubmitButton->setText(QApplication::translate("MainWindow", "Submit And Start", 0));
        UswerLabel->setText(QApplication::translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:16pt;\">Input User</span></p></body></html>", 0));
        PasswordLabel->setText(QApplication::translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:16pt;\">Input Password</span></p></body></html>", 0));
